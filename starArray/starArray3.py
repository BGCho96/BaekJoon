...
def solution(a):
    ...
    for curStr in a:
        ...
        if prev!=curStr and candidateScore[prev]%1 == 0:
            candidateScore[prev]+=0.25
            # print('잉여문자 입력으로 인한 부분 가점',curAll)
        elif prev==curStr and candidateScore[prev]%1 == 0:
            candidateScore[prev]+=0.75
            # print('후보문자 입력으로 인한 부분 가점',curAll)
        elif prev!=curStr and candidateScore[prev]%1 == 0.75:
            candidateScore[prev]+=0.25
